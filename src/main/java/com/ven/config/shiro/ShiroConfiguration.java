...
import com.ven.config.filter.CaptchaFilter;
import com.ven.config.filter.KickoutSessionControlFilter;
import com.ven.config.filter.MyFormAuthenticationFilter;
...
//		filters.put("authc",new MyPassThruAuthenticationFilter());
		...
		filterChainDefinitionMap.put("/**/*.*","anon");		// 静态资源
		filterChainDefinitionMap.put("/captcha", "anon");   //验证码
		 // 配置退出过滤器
        filterChainDefinitionMap.put("/site/logout", "logout");
